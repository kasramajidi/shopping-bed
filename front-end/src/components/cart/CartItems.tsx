  ...
  return (
    <div className="flex-1 space-y-6">
      {cartItems.map((item) => (
        <div
          key={item.id}
          className="flex flex-col  lg:flex-row items-start gap-6 pb-6 border-b border-[rgb(229,231,235)] p-4 mt-8 justify-between"
        >
          <Image
            width={96}
            height={96}
          ...
          <div className="flex flex-col items-center gap-2">
            <label htmlFor="amount" className="text-[rgb(57,78,106)] text-sm">
              Amount
            </label>
            <select
